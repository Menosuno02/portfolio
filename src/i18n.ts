...
const localTranslations: Translations = {
	en: {
		...
		"ee.experience.2.desc":
			"Project of an application for programming challenges. Developed in ASP.NET Core, React, Azure, SQL Server and Docker; and built with the Clean Architecture and the CQRS pattern. Training in technologies and techniques such as .NET Aspire, ACA, Microsoft Entra ID + MSAL, AutoMapper, MediatR or Unit Testing (MSTest, xUnit). Daily meetings and use of Azure DevOps",
	...
	es: {
		...
		"ee.experience.1.title": "Desarrollador Full Stack (prácticas)",
		"ee.experience.2.date": "Agosto 2024 - actualidad",
		"ee.experience.2.desc":
			"Proyecto de una aplicación para retos de programación. Desarrollada en ASP.NET Core, React, Azure, SQL Server y Docker; y construida con la arquitectura Clean Architecture y el patrón CQRS. Formación en tecnologías y técnicas como .NET Aspire, ACA, Microsoft Entra ID + MSAL, AutoMapper, MediatR o Unit Testing (MSTest, xUnit). Reuniones diarias y empleo de Azure DevOps",
		"ee.experience.2.title": "Cloud Solutions Developer",
